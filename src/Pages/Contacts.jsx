    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            ...
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-white rounded-lg shadow-md m-4 p-4 text-white">
                            <div onClick={() => togglePopup(el)} className="w-3/4 m-auto  ">
                                <img className="w-full object-cover rounded-full" src="https://img.uxwing.com/wp-content/themes/uxwing/download/peoples-avatars-thoughts/no-profile-picture-icon.png" alt="" />
                                <div className="p-4">
                                    {isOpen &&
                                        <Popup close={() => togglePopup(data)} el={singleContact} />

                                    }
                                </div>    <div className="text-center text-black">
                            ...
                            <div className="flex justify-between my-2">
                                ...
                                <button onClick={() => dispatch(removeContact(el.id))} className="rounded-[12px] p-2 bg-red-600 text-white">Delete</button>
                            </div>
                        </div>
                    })
                }
